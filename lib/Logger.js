...
const fs = require('fs')
// log files
// const output = fs.createWriteStream('/var/log/nodejs/storage.out')
// const outputErrors = fs.createWriteStream('/var/log/nodejs/storage.error')
const output = fs.createWriteStream('/home/gmazurco/storage.out')
const outputErrors = fs.createWriteStream('/home/gmazurco/storage.error')
